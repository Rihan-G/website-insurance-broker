...
- **[docs/CLOUDFLARE_PAGES_SPLIT_PORTALS.md](docs/CLOUDFLARE_PAGES_SPLIT_PORTALS.md)** — deploy separate client and staff portals as two Cloudflare Pages projects.  
