...
export function HomeHeroDashboardMockup() {
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-slate-950/85 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.55)] ring-1 ring-white/10">
