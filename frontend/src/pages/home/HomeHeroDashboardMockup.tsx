...
export function HomeHeroDashboardMockup() {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-cyan-400/25 via-primary-500/15 to-transparent blur-2xl" />
      <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-primary-950/85 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.55)] ring-1 ring-white/10">
        <div className="flex items-center gap-2 border-b border-white/10 bg-primary-900/80 px-4 py-3">
        ...
        <div className="grid gap-3 p-4 sm:p-5">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <span className="rounded-full bg-cyan-500/20 px-2 py-0.5 text-[10px] font-bold uppercase text-cyan-300 ring-1 ring-cyan-500/30">
              Active
            </span>
          </div>
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            <div className="rounded-xl border border-white/10 bg-white/5 p-3">
              ...
              <p className="text-[10px] text-cyan-300/90">Motor & home</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-3">
          ...
          <div className="rounded-xl border border-white/10 bg-gradient-to-br from-primary-900/80 to-primary-950/80 p-3">
            ...
            <ul className="mt-2.5 grid grid-cols-1 gap-1.5 sm:grid-cols-2">
              {clientFeatures.map(({ icon: Icon, label }) => (
                <li
                  key={label}
                  className="flex items-start gap-2 rounded-lg bg-primary-950/35 px-2 py-1.5 ring-1 ring-white/5"
                >
          ...
          <div className="space-y-2 rounded-xl border border-white/10 bg-white/5 p-3">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-2 rounded-lg bg-primary-950/40 px-2 py-2 ring-1 ring-white/5">
