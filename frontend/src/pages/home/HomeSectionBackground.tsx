...
export function HomeSectionBackground({ variant }: { variant: SectionVariant }) {
  ...
  const staticMeshClass =
    variant === "claims"
      ? "home-bg-static-mesh home-bg-static-mesh--claims"
      : variant === "cta"
        ? "home-bg-static-mesh home-bg-static-mesh--cta"
        : "home-bg-static-mesh";
  ...
  return (
    <div className="pointer-events-none absolute inset-0" aria-hidden>
      ...
      <div className="home-bg-fine-grain absolute inset-0" />
