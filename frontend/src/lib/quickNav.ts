...
export const QUICK_NAV_ITEMS: QuickNavItem[] = [
  ...
  { id: "notifications", label: "Notifications", to: "/dashboard/notifications", keywords: "alerts activity feed" },
  {
    ...
    to: "/dashboard/notifications?markAll=1",
    keywords: "clear inbox read all palette command",
  },
  { id: "tasks", label: "Tasks", to: "/dashboard/tasks", keywords: "sla follow up todo broker" },
  {
    id: "tasks-overdue",
    label: "Tasks — overdue only",
    to: "/dashboard/tasks?bucket=overdue",
    keywords: "late sla queue palette",
    roles: ["admin", "broker"],
  },
  {
    id: "tasks-due-soon",
    label: "Tasks — due within 7 days",
    to: "/dashboard/tasks?bucket=due_soon",
    keywords: "upcoming week palette",
    roles: ["admin", "broker"],
  },
